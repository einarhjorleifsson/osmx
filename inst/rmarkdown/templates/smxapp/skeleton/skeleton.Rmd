...
maelingar <- c("data-raw/TB1-2026_2.zip", "data-raw/TTH1-2026.zip", "data-raw/A4-2026.zip")
...
res$le.this.year <- 
  ...
  dplyr::mutate(lest = paste0(leidangur, "_", stringr::str_pad(stod, width = 3, pad = "0"))) |> 
